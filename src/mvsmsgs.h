 ...
 *******************************************************************************/
	...
	typedef enum {
		...
		InfoSyntax23=53,
		InfoCheckOption=54,
		InfoAPFAuthorization=55,
		InfoStdinDatasetAllocationSucceeded=56,
		InfoStdinDDName=57,	
		InfoStdinRecordTooLong=58,
		InfoDDNameHFSFile=59,
		InfoHFSAllocationSucceeded=60,
		InfoPDSMemberFreeSucceeded=61,
		InfoDatasetFreeSucceeded=62,
		InfoVolume=63,
		InfoAppend=64,
