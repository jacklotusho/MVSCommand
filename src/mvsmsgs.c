...
/*00*/	"",
/*01*/	"At least %s argument must be specified.\n", 
...
/*20*/	"Error deleting temporary dataset %s=%s.\n",
...
/*30*/	"Error allocating DDName %s to DUMMY.\n",
	...
	"Error reading from stdin to %s (backing temporary dataset %s).\n",	
/*40*/	"Error writing record %d to stdin temporary dataset %s.\n",
